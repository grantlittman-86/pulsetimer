...
#ifndef PULSETIMER_WATCH_APP_SWIFT_H
#define PULSETIMER_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PulseTimer_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Manages a <code>WKExtendedRuntimeSession</code> so the timer can keep ticking when the wrist
...
/// <code>willExpire</code> warns us before the session ends; we surface that to the engine so
/// the user gets a final haptic warning rather than silent failure.
SWIFT_CLASS("_TtC20PulseTimer_Watch_App24RuntimeSessionController")
@interface RuntimeSessionController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WKExtendedRuntimeSession;
@interface RuntimeSessionController (SWIFT_EXTENSION(PulseTimer_Watch_App)) <WKExtendedRuntimeSessionDelegate>
